...
def train(train_iter, model, args):
    ...
    for epoch in range(1, args.epochs+1):
        ...
        for batch in train_iter:
            ...
            # target = target - 1  # index align (标签从0-indexed转为0到num_classes-1)
...
def eval(data_iter, model, args):
    ...
    corrects, avg_loss, total_size = 0, 0, 0
    ...
    avg_loss /= total_size
    accuracy = 100.0 * corrects / total_size
